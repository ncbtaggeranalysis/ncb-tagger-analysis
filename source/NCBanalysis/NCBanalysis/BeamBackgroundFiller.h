 ...
 *
 * $Revision: 693118 $
 * $Date: 2015-09-04 03:27:46 -0400 (Fri, 04 Sep 2015) $
 */
...
public:
  ...
  //BeamBackgroundData* getBeamBackgroundData() {return p_beamBackgroundData;};
...
private:
  ...
  double GetSegmentTime(const xAOD::MuonSegment* pMuonSegment); 
  ...
  const xAOD::MuonSegmentContainer* p_cscSegmentContainer;
  const xAOD::MuonSegmentContainer* p_mdtSegmentContainer;
  ...
  ElementLinkVector<xAOD::MuonSegmentContainer> m_indexSeg;   
  ...
  bool m_useMDTSegmentsWitht0EqualTo0;
  bool m_useMDT;
};
